...
5. **Add linked content and discussion fetching for scoring** (area: backend) — Opt-in setting to fetch actual content behind link aggregator URLs (HN, Reddit, etc.) and detect discussion threads, feeding both into the scoring/categorization pipeline
