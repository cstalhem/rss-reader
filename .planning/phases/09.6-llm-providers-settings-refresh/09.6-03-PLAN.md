...
must_haves:
  ...
  key_links:
    ...
    - from: "frontend/src/components/settings/TopLevelModelSelector.tsx"
      ...
      via: "gets available models aggregated from all configured providers"
...
const { models } = useAvailableModels(); // Aggregated from all configured providers via GET /api/models
```
