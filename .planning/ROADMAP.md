...
Plans:
- [x] 09.6-01-PLAN.md -- Backend provider endpoints + frontend data layer (types, API, hook, catalog, logos)
- [x] 09.6-02-PLAN.md -- Provider UI: pill bar, Add Provider dialog, Ollama provider panel, page wiring
- [x] 09.6-03-PLAN.md -- Top-level grouped model selector (Combobox), dead code cleanup, visual verification
...
| 09.6. LLM Providers Settings       | v1.1      | 3/3                       | Complete            | 2026-03-01 |
